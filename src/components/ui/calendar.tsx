    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className: chevClassName, orientation, ...chevProps }) => {
          if (orientation === "left") {
            return (
              <ChevronLeftIcon className={cn("size-4", chevClassName)} {...chevProps} />
            )
          }
          if (orientation === "right") {
            return (
              <ChevronRightIcon className={cn("size-4", chevClassName)} {...chevProps} />
            )
          }
          return (
            <ChevronDownIcon className={cn("size-4", chevClassName)} {...chevProps} />
          )
        },
